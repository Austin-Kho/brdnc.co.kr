		<div style="width:758px; height:100%; margin:0px auto;"><!-- wrap div -->
			...
			<article style="width:750px; border:2px solid #96ABE5; background-color:white;">
				...
				<div style="height:100px; text-align:center; padding-top:25px; font-size:14px; color:#b0b0b0; margin-bottom:15px;">
				...
				<div style="margin: 0 20px 20px 20px; padding: 5px 0 0 10px; height: 50px; border-width:1px 0 1px 0; border-style:solid; border-color: #D5D5D5;  background-color: #eaeaea;">
					<h4>회원가입</h4>
				</div>
<?php
				...
				<fieldset style="padding: 0 20px 0 20px;" class="pale10">
					...
					<div style="border-width:1px 0 0 0; border-style:solid; border-color:#eaeaea;">
						<div class="form-group" style="padding: 5px 0 5px 0;">
							<label for="user_id" style="width:180px;" class="pale10">아 이 디 <span style="color:#cc0000">*</span></label>
							<input type="text" class="form-control input-sm" id="user_id" name="user_id" placeholder="ID" style="ime-mode:disabled;">
						 </div>
					...
					<div style="border-width:1px 0 0 0; border-style:solid; border-color:#eaeaea;">
						<div class="form-group" style="padding: 5px 0 5px 0;">
							<label for="passwd" style="width:180px;" class="pale10">비밀번호 <span style="color:#cc0000">*</span></label>
							<input type="password" class="form-control input-sm" id="passwd" name="passwd" placeholder="Password" style="ime-mode:disabled;">
						 </div>
					...
					<div style="border-width:0 0 0 0; border-style:solid; border-color:#eaeaea;">
						<div class="form-group" style="padding: 5px 0 5px 0;">
							...
							<input type="password" class="form-control input-sm" id="passcf" name="passcf" placeholder="" style="ime-mode:disabled;">
						 </div>
					...
					<div style="border-width:1px 0 0 0; border-style:solid; border-color:#eaeaea;">
						<div class="form-group" style="padding: 5px 0 5px 0;">
							<label for="name" style="width:180px;" class="pale10">이 름 <span style="color:#cc0000">*</span></label>
							<input type="text" class="form-control input-sm" id="name" placeholder=""  style="ime-mode:active;">
						 </div>
					</div>
					<div style="border-width:1px 0 0 0; border-style:solid; border-color:#eaeaea;">
						<div class="form-group" style="padding: 5px 0 5px 0;">
							<label for="email" style="width:180px;" class="pale10">Email <span style="color:#cc0000">*</span></label>
							<input type="email" class="form-control input-sm" id="email" name="emain" placeholder="Email address"  style="ime-mode:disabled;">
						 </div>
					...
					<div style="border-width:1px 0 0 0; border-style:solid; border-color:#eaeaea;">
						<div class="form-group" style="padding: 5px 0 5px 0;">
							<label for="zipcode" style="width:180px;" class="pale10">주 소</label>
							<input type="text" class="form-control input-sm" id="zipcode" style="width: 60px" readonly>
						 </div>
					...
					<div style="border-width:1px 0 0 0; border-style:solid; border-color:#eaeaea;">
						<div class="form-group" style="padding: 5px 0 5px 0;">
							<label for="phone1" style="width:180px;" class="pale10">전화번호</label>
					...
					<div style="border-width:1px 0 0 0; border-style:solid; border-color:#eaeaea;">
						<div class="form-group" style="padding: 5px 0 5px 0;">
							<label for="mobile1" style="width:180px;" class="pale10">휴대전화(Mobile) <span style="color:#cc0000">*</span></label>
					...
					<div style="border-width:1px 0 1px 0; border-style:solid; border-color:#CACAC1; text-align: center; background-color: #eaeaea;">
						<div class="form-group" style="padding: 20px 0 20px 0;">
							<button href="" class="btn btn-primary btn-sm">회원가입</button>
