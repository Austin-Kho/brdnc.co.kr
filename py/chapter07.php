      ...
      <section>
        <article class="">
          ...
          <p>
            ...
            <code><pre>def isPhoneNumber(text):<br>    if len(text) != 12:<br>        return False<br>    for i in range(0, 3):<br>        if not text[i].isdecimal():<br>            return False
    if text[3] != '-':<br>        return False<br>    for i in range(4, 7):<br>        if not text[i].isdecimal():<br>            return False<br>    if text[7] != '-':
        return False<br>    for i in range(8, 12):<br>        if not text[i].isdecimal():<br>            return False<br>    return True
              <br>print('415-555-4242 is a phone number:')<br>print(isPhoneNumber('415-555-4242'))<br>print('Moshi moshi is a phone number:')<br>print(isPhoneNumber('Moshi moshi'))</pre></code>
            <p>이 프로그램을 실행하면 출력은 다음과 같다.</p>
            <code><pre>415-555-4242 is a phone number:<br>True<br>Moshi moshi is a phone number:<br>False</pre></code>
            <p>더 큰 문자열에서 이 텍스트 패턴을 찾기 위해서는 더 많은 코드를 추가해야 한다. 위 isPhoneNumber() 함수에 아래에 다음 코드를 추가해 보자.</p>
            <code><pre>message = 'Call me at 415-555-1011 tomorrow. 415-555-9999 is my office.'<br>for i in range(len(message)):<br>    chunk = message[i:i+12]<br>    if isPhoneNumber(chunk):<br>        print('Phone number found: ' + chunk)<br>print('Done')</pre></code>
            <p>이 프로그램을 실행하면 출력은 다음과 같다.</p>
            <code><pre>Phone number found: 415-555-1011<br>Phone number found: 415-555-9999<br>Done</pre></code>
          </p>
          ...
          <p>
            ...
            <code><pre>>>> <strong>import re</strong></pre></code>
            ...
            <code><pre>>>> phoneNumRegex = <strong>re.compile(r'\d\d\d-\d\d\d-\d\d\d\d')</strong></pre></code>
          ...
          <p>
            ...
            <code><pre>>>> phoneNumRegex = re.compile(r'\d\d\d-\d\d\d-\d\d\d\d')<br>>>> mo = phoneNumRegex<strong>.search('My number is 415-555-4242.')</strong><br>>>> print('Phone number found: ' + <strong>mo.group()</strong>)<br>Phone number found: 415-555-4242</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> phoneNumRegex = re.compile(r'<strong>(\d\d\d)-(\d\d\d-\d\d\d\d)</strong>')<br>>>> mo = phoneNumRegex.search('My number is 415-555-4242.')<br>>>> <strong>mo.group(1)</strong><br>'415'<br>>>> <strong>mo.group(2)</strong><br>'555-4242'<br>mo.group()<br>'415-555-4242'</pre></code>
            <p><u>모든 그룹을 한 번에 가져오려면 <mark>groups() 메소드</mark>를 사용한다</u>. 이름이 복수형이라는 점에 유의하여야 한다.</p>
            <code><pre>>>> <strong>mo.groups()</strong><br>('415', '555-4242')<br>>>> <strong>areaCode, mainNumber</strong> = <strong>mo.groups()</strong><br>>>> print(<strong>areaCode</strong>)<br>415<br>>>> print(<strong>mainNumber</strong>)<br>555-4242</pre></code>
            ...
            <code><pre>>>> phoneNumRegex = re.compile(r'(<mark>\(</mark>\d\d\d<mark>\)</mark>) (\d\d\d-\d\d\d\d)')<br>>>> mo = phoneNumRegex.search('My number is (415) 555-4242.')<br>>>> mo.group(1)<br>'<mark>(</mark>415<mark>)</mark>'<br>>>> mo.group(2)<br>'555-4242'</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> heroRegex = re.compile(r'<strong>Batman|Tina Fey</strong>')<br>>>> mo1 = heroRegex.search('Batman and Tina Fey')<br>>>> mo1.group()<br>'Batman'
            <br>>>> mo2 = heroRegex.search('Tina Fey and Batman')<br>>>> mo2.group()<br>'Tina Fey'</pre></code>
            ...
            <code><pre>>>> batRegex = re.compile(r'Bat(man|mobile|copter|bat)')<br>>>> mo = batRegex.search('Batmobile lost a wheel')<br>>>> mo.group()<br>'<strong>Batmobile</strong>'<br>>> mo.group(1)<br>'<strong>mobile</strong>'</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> batRegex = re.compile(r'Bat<strong>(wo)?</strong>man')<br>>>> mo1 = batRegex.search('The Adventures of <strong>Batman</strong>')<br>>>> mo1.group()<br>'<strong>Batman</strong>'
              <br>>>> mo2 = batRegex.search('The Adventures of <strong>Batwoman</strong>')<br>>>> mo2.group<br>'<strong>Batwoman</strong>'</pre></code>
            ...
            <code><pre>>>> phoneNumRegex = re.compile(r'<strong>(\d\d\d-)?</strong>\d\d\d-\d\d\d\d')<br>>>> mo1 = phoneNumRegex.search('My number is 415-555-4242.')<br>>>> mo1.group()<br>'<strong>415-555-4242</strong>'
            <br>>>> mo2 = phoneNumRegex.search('My number is 555-4242.')<br>>>> mo2.group()<br>'<strong>555-4242</strong>'</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> batRegex = re.compile(r'Bat<strong>(wo)*</strong>man')<br>>>> mo1 = batRegex.search('The Adventures of <strong>Batman</strong>')<br>>>> mo1.group()<br>'<strong>Batman</strong>'
              ...
              <br>>>> mo3 = batRegex.search('The Adventures of <strong>Batwowowowoman</strong>')<br>>>> mo3.group()<br>'<strong>Batwowowowoman</strong>'</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> batRegex = re.compile(r'Bat<strong>(wo)+</strong>man')<br>>>> mo1 = batRegex.search('The Adventures of <strong>Batwoman</strong>')<br>>>> mo1.group()<br>'<strong>Batwoman</strong>'
              <br>>>> mo2 = batRegex.search('The Adventures of <strong>Batwowowowoman</strong>')<br>>>> mo2.group()<br>'<strong>Batwowowowoman</strong>'
              <br>>>> mo3 = batRegex.search('The Adventures of Batman')<br>>>> mo3 == <strong>None</strong><br>True</pre></code>
          ...
          <p>
            ...
            <code><pre><strong>(Ha){3}</strong><br>(Ha)(Ha)(Ha)</pre></code>
            <p>위 두 정규표현식은 같은 패턴과 일치한다.</p>
            <code><pre><strong>(Ha){3,5}</strong><br>((Ha)(Ha)(Ha)|(Ha)(Ha)(Ha)(Ha)|(Ha)(Ha)(Ha)(Ha)(Ha))</pre></code>
            <p>위 두 정규표현식도 같은 패턴과 일치한다.</p>
            <code><pre>>>> haRegex = re.compile(r'<strong>(Ha){3}</strong>')<br>>>> mo1 = haRegex.search('HaHaHa')<br>>>> mo1.group()<br>'<strong>HaHaHa</strong>'
              <br>>>> mo2 = haRegex.search('Ha')<br>>>> mo2 == <strong>None</strong><br>True</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> greedyHaRegex = re.compile(r'<strong>(Ha){3,5}</strong>')<br>>>> mo1 = greedyHaRegex.search('<strong>HaHaHaHaHa</strong>')<br>>>> mo1.group()<br>'<strong>HaHaHaHaHa</strong>'
              <br>>>> nongreedyHaRegex = re.compile(r'<strong>(Ha){3,5}?</strong>')<br>>>> mo2 = nongreedyHaRegex.search('<strong>HaHaHaHaHa</strong>')<br>>>> mo2.group()<br>'<strong>HaHaHa</strong>'</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> phoneNumRegex = re.compile(r'\d\d\d-\d\d\d-\d\d\d\d')<br>>>> mo = phoneNumRegex.search('Cell: 415-555-9999 Work: 212-555-0000')<br>>>> mo.group()<br>'415-555-9999'</pre></code>
            ...
            <code><pre>>>> phoneNumRegex = re.compile(r'<strong>\d\d\d-\d\d\d-\d\d\d\d</strong>') # has no groups<br>>>> phoneNumRegex.<strong>findall('Cell: 415-555-9999 Work: 212-555-0000')</strong><br>[<strong>'415-555-9999', '212-555-0000'</strong>]</pre></code>
            ...
            <code><pre>>>> phoneNumRegex = re.compile(r'<strong>(\d\d\d)-(\d\d\d)-(\d\d\d\d)</strong>')   # has groups<br>>>> phoneNumRegex.<strong>findall('Cell: 415-555-9999 Work: 212-555-0000')</strong><br>[<strong>('415', '555', '9999'), ('212', '555', '0000')</strong>]</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> xmasRegex = re.compile(r'\d+\s\w+')<br>>>> xmasRegex.findall('12 drummers, 11 pipers, 10 lords, 9 ladies, 8 maids, 7 swans, 6 geese, 5 rings, 4 birds, 3 hens, 2 doves, 1 partridge')
['12 drummers', '11 pipers', '10 lords', '9 ladies', '8 maids', '7 swans', '6 geese', '5 rings', '4 birds', '3 hens', '2 doves', '1 partridge']</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> vowelRegex = re.compile(r'<strong>[aeiouAEIOU]</strong>')<br>>>> vowelRegex.findall('RoboCop eats baby food. BABY FOOD.')<br>['o', 'o', 'o', 'e', 'a', 'a', 'o', 'o', 'A', 'O', 'O']</pre></code>
            ...
            <code><pre>>>> consonantRegex = re.compile(r'<strong>[^aeiouAEIOU]</strong>')<br>>>> consonantRegex.findall('RoboCop eats baby food. BABY FOOD.')<br>['R', 'b', 'c', 'p', ' ', 't', 's', ' ', 'b', 'b', 'y', ' ', 'f', 'd', '.', ' ', 'B', 'B', 'Y', ' ', 'F', 'D', '.']</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> beginsWithHello = re.compile(r'<strong>^Hello</strong>')<br>>>> beginsWithHello.search('Hello world')<br>&lt;re.Match object; span=(0, 5), match='<strong>Hello</strong>'><br>>>> beginsWithHello.search('He said hello.') == <strong>None</strong><br>True</pre></code>
            <p><u><mark>r'\d$'</mark> 정규표현식 문자열은 0에서 9까지의 숫자 글자로 끝나는 문자열과 일치</u>한다.</p>
            <code><pre>>>> endWithNumber = re.compile(r'<strong>\d$</strong>')<br>>>> endWithNumber.search('Your number is 42')<br>&lt;re.Match object; span=(16, 17), match='<strong>2</strong>'><br>>>> endWithNumber.search('Your number is forty two.') == <strong>None</strong><br>True</pre></code>
            <p><u><mark>r'^\d$'</mark> 정규표현식 문자열은 하나 또는 그보다 많은 숫자 글자로 시작하고 끝나는 문자열과 일치</u>한다.</p>
            <code><pre>>>> wholeStringIsNum = re.compile(r'<strong>^\d+$</strong>')<br>>>> wholeStringIsNum.search('1234567890')<br>&lt;re.Match object; span=(0, 10), match='<strong>1234567890</strong>'><br>>>> wholeStringIsNum.search('12345xyz67890') == <strong>None</strong><br>True<br>>>> wholeStringIsNum.search('12  34567890') == <strong>None</strong><br>True</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> atRegex = re.compile(r'<strong>.at</strong>')<br>>>> atRegex.findall('The cat in the hat sat on the flat mat.')<br>['cat', 'hat', 'sat', 'lat', 'mat']</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> nameRegex = re.compile(r'First Name: (<strong>.*</strong>) Last Name: (.*)')<br>>>> mo = nameRegex.search('First Name: <strong>Al</strong> Last Name: <strong>Sweigart</strong>')<br>>>> mo.group(1)<br>'<strong>Al</strong>'<br>>>> mo.group(2)<br>'<strong>Sweigart</strong>'</pre></code>
            ...
            <code><pre>>>> nongreedyRegex = re.compile(r'<<strong>.*?</strong>>')<br>>>> mo = nongreedyRegex.search('&lt;To serve man> for dinner.>')<br>>>> mo.group()<br>'<strong>&lt;To serve man></strong>'
              <br>>>> greedyRegex = re.compile(r'<<strong>.*</strong>>')<br>>>> mo = greedyRegex.search('&lt;To serve man> for dinner.>')<br>>>> mo.group()<br>'<strong>&lt;To serve man> for dinner.></strong>'</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> regex1 = re.compile('RoboCop')<br>>>> regex2 = re.compile('ROBOCOP')<br>>>> regex3 = re.compile('robOcop')<br>>>> regex4 = re.compile('RobocOp')</pre></code>
            ...
            <code><pre>>>> robocop = re.compile(r'robocop', <strong>re.I</strong>)<br>>>> robocop.search('RoboCop is part man, part machine, all cop.').group()<br>'<strong>RoboCop</strong>'
            <br>>>> robocop.search('ROBOCOP protects the innocent.').group()<br>'<strong>ROBOCOP</strong>'
            <br>>>> robocop.search('Al, why does your programming book talk about robocop so much?').group()<br>'<strong>robocop</strong>'</pre></code>
          </p>
          ...
          <p>
            ...
            <code><pre>>>> namesRegex = re.compile(r'Agent \w+')<br>>>> namesRegex.<strong>sub</strong>('<strong>CENSORED</strong>', 'Agent Alice gave the secret documents to Agent Bob.')<br>'<strong>CENSORED</strong> gave the secret documents to <strong>CENSORED</strong>.'</pre></code>
            ...
            <code><pre>>>> agentNameRegex = re.compile(r'Agent (\w)\w*')<br>>>> agentNameRegex.<strong>sub</strong>(r'<strong>\1****</strong>', 'Agent Alice told Agent Carol that Agent Eve knew Agent Bob was a double agent.')<br>'<strong>A****</strong> told <strong>C****</strong> that <strong>E****</strong> knew <strong>B****</strong> was a double agent.'</pre></code>
          </p>
          ...
          <p>
            ...
            <code><pre>phoneRegex = re.compile(r'((\d{3}|\(\d{3}\))?(\s|-|\.)?\d{3}(\s|-|\.)\d{4}(\s*(ext|x|ext.)\s*\d{2,5})?)')</pre></code>
            <p>여러 줄에 걸쳐 주석을 붙인 정규표현식으로 나눌 수 있다.</p>
            <code><pre>phoneRegex = re.compile(r<strong>'''</strong>(
    (\d{3}|\(\d{3}\))?             # area code
    (\s|-|\.)?                     # separator
    \d{3}                          # first 3 digits
    (\s|-|\.)                      # separator
    ...
    (\s*(ext|x|ext.)\s*\d{2,5})?   # extension
    )<strong>''', re.VERBOSE</strong>)</pre></code>
          ...
          <p>
            ...
            <code><pre>>>> someRegexValue = re.compile('foo', <strong>re.IGNORECASE | re.DOTALL | re.VERBOSE</strong>)</pre></code>
          ...
          <p>
            ...
            <code><pre>#! python3<br>#  phoneAndEmail.py - Finds phone numbers and email addresses on the clipboard.
    ...
    (\s*(ext|x|ext.)\s*(\d{2,5}))? # extension / 선택적인 내선번호로 몇 개든 숫자가 나온 후 ext, x 또는 ext가 나오고 그 뒤에 2-5개의 숫자가 나온다.
            ...
            <br># TODO : Copy results to the clipboard.</pre></code>
...
for groups in emailRegex.findall(text):<br>    matches.append(groups[0])
    ...
    print('\n'.join(matches))<br>else:<br>    print('No phone numbers or email addresses found.')</strong></pre></code>
          ...
          <p>
            ...
            <ul>
              ...
              <code><pre>'42'<br>'1,234'<br>'6,368,745'</pre></code><p>그러나 다음과 일치해서는 안된다.</p>
              <code><pre>'12,34,567' (which has only two digits between commas)<br>'1234' (which lacks commas)</pre></code>
              ...
              <code><pre>'Satoshe Nakamoto'<br>'Alice Nakamoto'<br>'RoboCop Nakamoto'</pre></code><p>그러나 다음과 일치해서는 안된다.</p>
              <code><pre>'satoshe Nakamoto' (이름의 첫글자가 대문자가 아니기 때문에)<br>'Mr. Nakamoto' (앞에 있는 단어에 문자가 아닌 기호가 있기 때문에)<br>'Nakamoto' (이름이 없기 때문에)<br>'Satoshi nakamoto' (nakamoto의 첫 글자가 대문자가 아니기 때문에)</pre></code>
              ...
              <code><pre>'Alice eats apples.'<br>'Bob pets cats.'<br>'Carol throws baseballs'<br>'Alice throws Apples.'<br>'BOB EATS CATS.'</pre></code><p>그러나 다음과 일치해서는 안된다.</p>
              <code><pre>'RoboCop eats apples.'<br>'ALICE THROWS FOOTBALLS.'<br>'Carol eats 7 cats.'</pre></code>
          </p>
