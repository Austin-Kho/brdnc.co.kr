	...
	<fieldset>
		...
		<div class="row <?php if( !is_mobile()) echo 'no-mobile';?>">
			...
			<div class="form-group col-xs-12 col-sm-8 col-md-4 form-wrap">
		        ...
		        <button class="btn btn-default btn-sm" type="button" onclick="javascript:open_Win('/popup/tax_off/lists/1/1/', 'tax_search', 500, 586)">
			...
			<div class="form-group col-xs-12 col-sm-8 col-md-4 form-wrap">
				<div class="col-xs-3  input-group">
					...
					<span class="input-group-btn">
	        <button class="btn btn-default btn-sm" type="button" onclick="javascript:open_Win('/popup/tax_off/lists/1/2/', 'tax_search', 500, 586)">
	        	&nbsp;<span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span>
	        </button>
	      </span>
				</div>
