...
?>
				<fieldset class="font12">
					...
					<div class="form-group <?php if( !$this->agent->is_mobile()) echo 'bo-top';?>" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-3" style="padding-right: 0;">
								<input type="text" class="form-control input-sm en_only" id="co_no1" name="co_no1" maxlength="3" value="<?php if($mode=='com_reg') {echo set_value('co_no1');} else {echo substr($com->co_no, 0, 3);} ?>" onkeydown="isNum();" required autofocus>
							</div>
							<div class="col-xs-2" style="padding-right: 0;">
								<label for="co_no2" class="sr-only">사업자번호2 </label>
								<input type="text" class="form-control input-sm en_only" id="co_no2" name="co_no2" maxlength="2" value="<?php if($mode=='com_reg') {echo set_value('co_no2');} else {echo substr($com->co_no, 4, 2);} ?>" onkeydown="isNum();" required autofocus>
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
								<label for="co_no3" class="sr-only">사업자번호3 </label>
								<input type="text" class="form-control input-sm wid-90 en_only" id="co_no3" name="co_no3" maxlength="5" value="<?php if($mode=='com_reg') {echo set_value('co_no3');} else {echo substr($com->co_no, 7, 11);} ?>" onkeydown="isNum();" required autofocus>
							</div>
							<div class="col-xs-4">
					...
					<div class="form-group <?php if( !$this->agent->is_mobile()) echo 'bo-top';?>" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-3" style="padding-right: 0;">
								<input type="text" class="form-control input-sm en_only" id="or_no1" name="or_no1" maxlength="6" value="<?php if($mode=='com_reg') {echo set_value('or_no1');} else {echo substr($com->or_no, 0, 6);} ?>" onkeydown="isNum();" required autofocus>
							</div>
					      	<div class="col-xs-4" style="padding-right: 0;">
					      		<label for="or_no2" class="sr-only">법인(주민)등록번호2 </label>
					      		<input type="text" class="form-control input-sm en_only" id="or_no2" name="or_no2" maxlength="7" value="<?php if($mode=='com_reg') {echo set_value('or_no2');} else {echo substr($com->or_no, 7, 13);} ?>" onkeydown="isNum();" required autofocus>
					      	</div>
					      	<div class="col-xs-5">
					...
					<div class="form-group <?php if( !$this->agent->is_mobile()) echo 'bo-top';?>" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-3" style="padding-right: 0;">
								<input type="text" class="form-control input-sm en_only" id="co_phone1" name="co_phone1" maxlength="4" value="<?php if($mode=='com_reg') {echo set_value('co_phone1');} else {$p = explode('-', $com->co_phone); echo $p[0];} ?>" onkeydown="isNum();" required autofocus>
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
								<label for="co_phone2" class="sr-only">대표전화2</label>
								<input type="text" class="form-control input-sm en_only" id="co_phone2" name="co_phone2" maxlength="4" value="<?php if($mode=='com_reg') {echo set_value('co_phone2');} else {$p = explode('-', $com->co_phone); echo $p[1];} ?>" onkeydown="isNum();" required autofocus>
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
								<label for="co_phone3" class="sr-only">대표전화3</label>
								<input type="text" class="form-control input-sm en_only" id="co_phone3" name="co_phone3" maxlength="4" value="<?php if($mode=='com_reg') {echo set_value('co_phone3');} else {$p = explode('-', $com->co_phone); echo $p[2];} ?>" onkeydown="isNum();" required autofocus>
							</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							...
							<div class="col-xs-3" style="padding-right: 0;">
								...
								<input type="text" class="form-control input-sm en_only" id="co_hp2" name="co_hp2" maxlength="4" value="<?php if($mode=='com_reg') {echo set_value('co_hp2');} else {$p = explode('-', $com->co_hp); echo $p[1];} ?>" onkeydown="isNum();" required autofocus>
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
								<label for="co_hp3" class="sr-only">휴대전화2</label>
								<input type="text" class="form-control input-sm en_only" id="co_hp3" name="co_hp3" maxlength="4" value="<?php if($mode=='com_reg') {echo set_value('co_hp3');} else {$p = explode('-', $com->co_hp); echo $p[2];} ?>" onkeydown="isNum();" required autofocus>
							</div>
							<div class="col-xs-3"></div>
						</div>
					</div>
					<div class="form-group <?php if( !$this->agent->is_mobile()) echo 'bo-top';?>" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-3" style="padding-right: 0;">
								<input type="text" class="form-control input-sm en_only" id="co_fax1" name="co_fax1" maxlength="4" value="<?php if($mode=='com_reg') {echo set_value('co_fax1');} else {$p = explode('-', $com->co_fax); echo $p[0];} ?>" onkeydown="isNum();">
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
								<label for="co_fax2" class="sr-only">FAX2</label>
								<input type="text" class="form-control input-sm en_only" id="co_fax2" name="co_fax2" maxlength="4" value="<?php if($mode=='com_reg') {echo set_value('co_fax2');} else {$p = explode('-', $com->co_fax); echo $p[1];} ?>" onkeydown="isNum();">
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
								<label for="co_fax3" class="sr-only">FAX3</label>
								<input type="text" class="form-control input-sm en_only" id="co_fax3" name="co_fax3" maxlength="4" value="<?php if($mode=='com_reg') {echo set_value('co_fax3');} else {$p = explode('-', $com->co_fax); echo $p[2];} ?>" onkeydown="isNum();">
							</div>
							<div class="col-xs-3"></div>
						</div>
					...
					<div class="form-group <?php if( !$this->agent->is_mobile()) echo 'bo-top';?>" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-3" style="padding-right: 0;">
								<input type="text" class="form-control input-sm en_only" id="carr_y" name="carr_y" maxlength="4" value="<?php if($mode=='com_reg') {echo set_value('carr_y');} else {$a = explode('-', $com->carr); echo $a[0];} ?>" onkeydown="isNum();" required autofocus>
							</div>
							<div class="col-xs-1 text-wrap">년</div>
							<div class="col-xs-2" style="padding-right: 0;">
								<label for="carr_m" class="sr-only">기초잔액 입력월2</label>
								<input type="text" class="form-control input-sm en_only" id="carr_m" name="carr_m" maxlength="2" value="<?php if($mode=='com_reg') {echo set_value('carr_m');} else {$a = explode('-', $com->carr); echo $a[1];} ?>" onkeydown="isNum();" required autofocus>
							</div>
