...
class M1 extends CI_Controller {
	...
	public function sales($mdi='', $sdi=''){
		...
		$menu['s_di'] = array(
			...
			array('현장별 계약현황<구축 작업 전>', '현장별 계약등록(수정)<구축 작업 전>', '동호수 계약 현황표<구축 작업 전>'),  // 첫번째 하위 제목
			array('분양대금 수납 현황<구축 작업 전>', '분양대금 수납 등록<구축 작업 전>', '프로젝트 타입별 수납약정 등록 수정<구축 작업 전>')   // 두번째 하위 제목
		);
