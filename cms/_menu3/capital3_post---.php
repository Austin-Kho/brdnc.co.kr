...
<?
	...
	// 현장으로 전도금 송금시 현장 코드
	$pj_seq = array($_REQUEST['pj_seq_1'], $_REQUEST['pj_seq_2'], $_REQUEST['pj_seq_3'], $_REQUEST['pj_seq_4'], $_REQUEST['pj_seq_5'], $_REQUEST['pj_seq_6'], $_REQUEST['pj_seq_7'], $_REQUEST['pj_seq_8'], $_REQUEST['pj_seq_9'], $_REQUEST['pj_seq_10']);
	...
	// 조합 대여금 여부
	$jh_loan = array($_REQUEST['jh_loan_1'], $_REQUEST['jh_loan_2'], $_REQUEST['jh_loan_3'], $_REQUEST['jh_loan_4'], $_REQUEST['jh_loan_5'], $_REQUEST['jh_loan_6'], $_REQUEST['jh_loan_7'], $_REQUEST['jh_loan_8'], $_REQUEST['jh_loan_9'], $_REQUEST['jh_loan_10']);
	...
	// 계정과목
	$account = array($_REQUEST['account_1'], $_REQUEST['account_2'], $_REQUEST['account_3'], $_REQUEST['account_4'], $_REQUEST['account_5'], $_REQUEST['account_6'], $_REQUEST['account_7'], $_REQUEST['account_8'], $_REQUEST['account_9'], $_REQUEST['account_10']);
