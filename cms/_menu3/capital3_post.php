...
<?
	...
	// 입출대체 구분
	$class1 = array($_POST['class1_1'], $_POST['class1_2'], $_POST['class1_3'], $_POST['class1_4'], $_POST['class1_5'], $_POST['class1_6'], $_POST['class1_7'], $_POST['class1_8'], $_POST['class1_9'], $_POST['class1_10']);

	// 입출금 세부 구분
	$class2 = array($_POST['class2_1'], $_POST['class2_2'], $_POST['class2_3'], $_POST['class2_4'], $_POST['class2_5'], $_POST['class2_6'], $_POST['class2_7'], $_POST['class2_8'], $_POST['class2_9'], $_POST['class2_10']);

	// 현장으로 전도금 송금시 현장 코드
	$pj_seq = array($_POST['pj_seq_1'], $_POST['pj_seq_2'], $_POST['pj_seq_3'], $_POST['pj_seq_4'], $_POST['pj_seq_5'], $_POST['pj_seq_6'], $_POST['pj_seq_7'], $_POST['pj_seq_8'], $_POST['pj_seq_9'], $_POST['pj_seq_10']);

	// 조합 대여금 여부
	$jh_loan = array($_POST['jh_loan_1'], $_POST['jh_loan_2'], $_POST['jh_loan_3'], $_POST['jh_loan_4'], $_POST['jh_loan_5'], $_POST['jh_loan_6'], $_POST['jh_loan_7'], $_POST['jh_loan_8'], $_POST['jh_loan_9'], $_POST['jh_loan_10']);
	...
	// 계정과목
	$account = array($_POST['account_1'], $_POST['account_2'], $_POST['account_3'], $_POST['account_4'], $_POST['account_5'], $_POST['account_6'], $_POST['account_7'], $_POST['account_8'], $_POST['account_9'], $_POST['account_10']);

	// 적요
	$cont = array($_POST['cont_1'], $_POST['cont_2'], $_POST['cont_3'], $_POST['cont_4'], $_POST['cont_5'], $_POST['cont_6'], $_POST['cont_7'], $_POST['cont_8'], $_POST['cont_9'], $_POST['cont_10']);

	// 거래처
	$acc = array($_POST['acc_1'], $_POST['acc_2'], $_POST['acc_3'], $_POST['acc_4'], $_POST['acc_5'], $_POST['acc_6'], $_POST['acc_7'], $_POST['acc_8'], $_POST['acc_9'], $_POST['acc_10']);

	// 입금계정
	$ina = array($_POST['in_1'], $_POST['in_2'], $_POST['in_3'], $_POST['in_4'], $_POST['in_5'], $_POST['in_6'], $_POST['in_7'], $_POST['in_8'], $_POST['in_9'], $_POST['in_10']);

	// 입금액
	$inc = array($_POST['inc_1'], $_POST['inc_2'], $_POST['inc_3'], $_POST['inc_4'], $_POST['inc_5'], $_POST['inc_6'], $_POST['inc_7'], $_POST['inc_8'], $_POST['inc_9'], $_POST['inc_10']);

	// 출금액
	$exp = array($_POST['exp_1'], $_POST['exp_2'], $_POST['exp_3'], $_POST['exp_4'], $_POST['exp_5'], $_POST['exp_6'], $_POST['exp_7'], $_POST['exp_8'], $_POST['exp_9'], $_POST['exp_10']);
	...
	// echo $out[2][0]."---".$out[2][1]."<br>";
	// echo $out[3][0]."---".$out[3][1]."<br>";
	// echo $out[4][0]."---".$out[4][1]."<br>";
	// echo $out[5][0]."---".$out[5][1]."<br>";
	// echo $out[6][0]."---".$out[6][1]."<br>";
	// echo $out[7][0]."---".$out[7][1]."<br>";
	// echo $out[8][0]."---".$out[8][1]."<br>";
	// echo $out[9][0]."---".$out[9][1]."<br>";
		...
		for($i=0; $i<10; $i++){
			if($class1[$i]&&$class2[$i]){
				$query1="INSERT INTO `cms_capital_cash_book` (`com_div`, `pj_seq`, `class1`, `class2`, `is_jh_loan`, `any_jh`, `account`, `cont`, `acc`, `in_acc`, `inc`, `out_acc`, `exp`, `evidence`, `worker`, `deal_date`)
							  VALUES('$com_div[$i]', '$pj_seq[$i]', '$class1[$i]', '$class2[$i]', '$jh_loan[$i]', '$any_jh[$i]', '$account[$i]', '$cont[$i]', '$acc[$i]', '$ina[$i]', '$inc[$i]', '$out[$i][0]', '$exp[$i]', '$evi[$i]', '$worker', '$deal_date')";
			...
			if($char1_1=='on'){
				$query1="INSERT INTO `cms_capital_cash_book` (`com_div`, `class1`, `class2`, `account`, `cont`, `acc`, `out_acc`, `exp`, `evidence`, `worker`, `deal_date`)
							  VALUES('$com_div[$i]', '2', '5', '지급수수료', '$cont_h[$i]', '$out[$i][1]', '$out[$i][0]', '$char2[$i]', '1', '$worker', '$deal_date')";
				$result1=mysql_query($query1, $connect);
				if(!$result1) err_msg('데이터베이스 오류가 발생하였습니다.');     // util.php 파일에 선언한 err_msg()함수 호출, 메세지 출력 후 이전페이지로.
			}
		}
