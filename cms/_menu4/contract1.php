					...
					<!-- ===== subject table end ===== -->
					<?
						$_m4_2_1_rlt = mysql_query("select _m4_2_1 from cms_mem_auth where user_id='$_SESSION[p_id]' ", $connect);
						$_m4_2_1_row = mysql_fetch_array($_m4_2_1_rlt);

						if(!$_m4_2_1_row[_m4_2_1]||$_m4_2_1_row[_m4_2_1]==0){
					?>
