...
?>
		...
		<div class="row" style="margin: 0; padding: 0;">
			<div class="bg-success col-xs-4 col-sm-4 col-md-2 bo-top bo-bottom" style="padding-top: 10px; margin-bottom: 20px; height: 40px;">회사 정보</div>
				...
				<fieldset class="font12">
					...
					<div class="form-group bo-top" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-8">
								<input type="text" class="form-control input-sm han" id="co_name" name="co_name" maxlength="30" value="<?php if($data['mode']=='com_reg') {echo set_value('co_name');} else {echo $data['com']->co_name;} ?>" required>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4 col-md-2 label-wrap">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							...
							<div class="col-xs-4">
								...
								<select class="form-control input-sm wid-90" id="co_form" name="co_form" required>
									...
									<option value="1" <?php if($data['mode']=='com_reg'){echo set_select('co_form', '1');}else{if($data['com']->co_form==1) echo 'selected';} ?>>법인</option>
									<option value="2" <?php if($data['mode']=='com_reg'){echo set_select('co_form', '2');}else{if($data['com']->co_form==2) echo 'selected';} ?>>개인(일반)</option>
									<option value="3" <?php if($data['mode']=='com_reg'){echo set_select('co_form', '3');}else{if($data['com']->co_form==3) echo 'selected';} ?>>개인(간이)</option>
								</select>
							</div>
						</div>
					</div>
					...
					<div class="form-group bo-top" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-8">
								<input type="text" class="form-control input-sm han" id="ceo" name="ceo" maxlength="30" value="<?php if($data['mode']=='com_reg') {echo set_value('ceo');} else {echo $data['com']->ceo;} ?>" required>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4 col-md-2 label-wrap">
							...
							<div class="col-xs-3" style="padding-right: 0;">
					      	...
					      	<div class="col-xs-5">
								...
								<select class="form-control input-sm wid-90" id="sur" name="sur" required>
									<option value="">선택</option>
									<option value="1" <?php if($data['mode']=='com_reg'){echo set_select('sur', '1');}else{if($data['com']->sur==1) echo 'selected';} ?>>부가세 분기 신고</option>
									<option value="2" <?php if($data['mode']=='com_reg'){echo set_select('sur', '2');}else{if($data['com']->sur==2) echo 'selected';} ?>>부가세 반기 신고</option>
									<option value="3" <?php if($data['mode']=='com_reg'){echo set_select('sur', '3');}else{if($data['com']->sur==3) echo 'selected';} ?>>부가세 월별 신고</option>
								</select>
							</div>
						</div>
					</div>
					...
					<div class="form-group bo-top" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-8">
								<input type="text" class="form-control input-sm han" id="biz_cond" name="biz_cond" maxlength="30" value="<?php if($data['mode']=='com_reg') {echo set_value('biz_cond');} else {echo $data['com']->biz_cond;} ?>" required>
							</div>
						</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-8">
								<input type="text" class="form-control input-sm han" id="biz_even" name="biz_even" maxlength="30" value="<?php if($data['mode']=='com_reg') {echo set_value('biz_even');} else {echo $data['com']->biz_even;} ?>" required>
							</div>
						</div>
					</div>
					<div class="form-group bo-top" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-3" style="padding-right: 0;">
								<select class="form-control input-sm" id="co_hp1" name="co_hp1" required>
									<option value="">선택</option>
									<option value="010" <?php if($data['mode']=='com_reg'){echo set_select('co_hp1', '010');}else{if(substr($data['com']->co_hp, 0, 3)=='010') echo 'selected';} ?>>010</option>
									<option value="011" <?php if($data['mode']=='com_reg'){echo set_select('co_hp1', '011');}else{if(substr($data['com']->co_hp, 0, 3)=='011') echo 'selected';} ?>>011</option>
									<option value="016" <?php if($data['mode']=='com_reg'){echo set_select('co_hp1', '016');}else{if(substr($data['com']->co_hp, 0, 3)=='016') echo 'selected';} ?>>016</option>
									<option value="017" <?php if($data['mode']=='com_reg'){echo set_select('co_hp1', '017');}else{if(substr($data['com']->co_hp, 0, 3)=='017') echo 'selected';} ?>>017</option>
									<option value="018" <?php if($data['mode']=='com_reg'){echo set_select('co_hp1', '018');}else{if(substr($data['com']->co_hp, 0, 3)=='018') echo 'selected';} ?>>018</option>
									<option value="019" <?php if($data['mode']=='com_reg'){echo set_select('co_hp1', '019');}else{if(substr($data['com']->co_hp, 0, 3)=='019') echo 'selected';} ?>>019</option>
								</select>
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-4" style="padding-right: 0;">
								<select class="form-control input-sm" id="co_div1" name="co_div1">
									<option value="">선택</option>
									<option value="1" <?php if($data['mode']=='com_reg'){echo set_select('co_div1', '1');}else{if($data['com']->co_div1==1) echo 'selected';} ?>>중소기업</option>
									<option value="2" <?php if($data['mode']=='com_reg'){echo set_select('co_div1', '2');}else{if($data['com']->co_div1==2) echo 'selected';} ?>>비중소기업</option>
								</select>
							</div>
							<div class="col-xs-4" style="padding-right: 0;">
								...
								<select class="form-control input-sm" id="co_div2" name="co_div2">
									<option value="">선택</option>
									<option value="1" <?php if($data['mode']=='com_reg'){echo set_select('co_div2', '1');}else{if($data['com']->co_div2==1) echo 'selected';} ?>>중소기업</option>
									<option value="2" <?php if($data['mode']=='com_reg'){echo set_select('co_div2', '2');}else{if($data['com']->co_div2==2) echo 'selected';} ?>>일반</option>
									<option value="3" <?php if($data['mode']=='com_reg'){echo set_select('co_div2', '3');}else{if($data['com']->co_div2==3) echo 'selected';} ?>>상장</option>
									<option value="4" <?php if($data['mode']=='com_reg'){echo set_select('co_div2', '4');}else{if($data['com']->co_div2==4) echo 'selected';} ?>>비상장기업</option>
									<option value="5" <?php if($data['mode']=='com_reg'){echo set_select('co_div2', '5');}else{if($data['com']->co_div2==5) echo 'selected';} ?>>공공</option>
									<option value="6" <?php if($data['mode']=='com_reg'){echo set_select('co_div2', '6');}else{if($data['com']->co_div2==6) echo 'selected';} ?>>비영리</option>
								</select>
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
								...
								<select class="form-control input-sm" id="co_div3" name="co_div3">
									<option value="">선택</option>
									<option value="1" <?php if($data['mode']=='com_reg'){echo set_select('co_div3', '1');}else{if($data['com']->co_div3==1) echo 'selected';} ?>>내국</option>
									<option value="2" <?php if($data['mode']=='com_reg'){echo set_select('co_div3', '2');}else{if($data['com']->co_div3==2) echo 'selected';} ?>>외국</option>
									<option value="3" <?php if($data['mode']=='com_reg'){echo set_select('co_div3', '3');}else{if($data['com']->co_div3==3) echo 'selected';} ?>>외투</option>
								</select>
							</div>
                ...
                <div>
                  <input type="text" class="form-control input-sm wid-100" id="op_date" name="op_date" maxlength="10" value="<?php if($data['mode']=='com_reg') {echo set_value('op_date');} else {echo $data['com']->op_date;} ?>" readonly onClick="cal_add(this); event.cancelBubble=true" maxlength="10" required>
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-3" style="padding-right: 0;">
								<select class="form-control input-sm" id="m_wo_st" name="m_wo_st" required>
									<option value="">선택</option>
									<option value="01" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '01');}else{if($data['com']->m_wo_st=='01') echo 'selected';} ?>>01</option>
									<option value="02" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '02');}else{if($data['com']->m_wo_st=='02') echo 'selected';} ?>>02</option>
									<option value="03" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '03');}else{if($data['com']->m_wo_st=='03') echo 'selected';} ?>>03</option>
									<option value="04" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '04');}else{if($data['com']->m_wo_st=='04') echo 'selected';} ?>>04</option>
									<option value="05" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '05');}else{if($data['com']->m_wo_st=='05') echo 'selected';} ?>>05</option>
									<option value="06" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '06');}else{if($data['com']->m_wo_st=='06') echo 'selected';} ?>>06</option>
									<option value="07" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '07');}else{if($data['com']->m_wo_st=='07') echo 'selected';} ?>>07</option>
									<option value="08" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '08');}else{if($data['com']->m_wo_st=='08') echo 'selected';} ?>>08</option>
									<option value="09" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '09');}else{if($data['com']->m_wo_st=='09') echo 'selected';} ?>>09</option>
									<option value="10" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '10');}else{if($data['com']->m_wo_st=='10') echo 'selected';} ?>>10</option>
									<option value="11" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '11');}else{if($data['com']->m_wo_st=='11') echo 'selected';} ?>>11</option>
									<option value="12" <?php if($data['mode']=='com_reg'){echo set_select('m_wo_st', '12');}else{if($data['com']->m_wo_st=='12') echo 'selected';} ?>>12</option>
								</select>
							</div>
							...
							<div class="col-xs-3" style="padding-right: 0;">
								...
								<select class="form-control input-sm" id="bl_cycle" name="bl_cycle" required>
									<option value="">선택</option>
									<option value="01" <?php if($data['mode']=='com_reg'){echo set_select('bl_cycle', '01');}else{if($data['com']->bl_cycle=='01') echo 'selected';} ?>>01</option>
									<option value="02" <?php if($data['mode']=='com_reg'){echo set_select('bl_cycle', '02');}else{if($data['com']->bl_cycle=='02') echo 'selected';} ?>>02</option>
									<option value="03" <?php if($data['mode']=='com_reg'){echo set_select('bl_cycle', '03');}else{if($data['com']->bl_cycle=='03') echo 'selected';} ?>>03</option>
									<option value="04" <?php if($data['mode']=='com_reg'){echo set_select('bl_cycle', '04');}else{if($data['com']->bl_cycle=='04') echo 'selected';} ?>>04</option>
									<option value="06" <?php if($data['mode']=='com_reg'){echo set_select('bl_cycle', '06');}else{if($data['com']->bl_cycle=='06') echo 'selected';} ?>>06</option>
									<option value="12" <?php if($data['mode']=='com_reg'){echo set_select('bl_cycle', '12');}else{if($data['com']->bl_cycle=='12') echo 'selected';} ?>>12</option>
								</select>
							</div>
					...
					<div class="form-group bo-top" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-3" style="padding-right: 0;">
								<input type="text" class="form-control input-sm en_only" id="email1" name="email1" maxlength="30" value="<?php if($data['mode']=='com_reg') {echo set_value('email1');} else {$a = explode('@', $data['com']->email); echo $a[0];} ?>" required>
							</div>
							<div class="col-xs-1 text-wrap">@</div>
							<div class="col-xs-4" style="padding-right: 0;">
									<label for="email2" class="sr-only">이메일2</label>
									<input type="text" class="form-control input-sm en_only" id="email2" name="email2" maxlength="30" value="<?php if($data['mode']=='com_reg') {echo set_value('email2');} else {$a = explode('@', $data['com']->email); echo $a[1];} ?>" required>
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 form-wrap">
							<div class="col-xs-3" style="padding-right: 0;">
								<input type="text" class="form-control input-sm en_only" id="calc_mail1" name="calc_mail1" maxlength="30" value="<?php if($data['mode']=='com_reg') {echo set_value('calc_mail1');} else {$a = explode('@', $data['com']->calc_mail); echo $a[0];} ?>" required>
							</div>
							<div class="col-xs-1 text-wrap">@</div>
							<div class="col-xs-4" style="padding-right: 0;">
									<label for="calc_mail2" class="sr-only">세금계산서이메일2</label>
									<input type="text" class="form-control input-sm en_only" id="calc_mail2" name="calc_mail2" maxlength="30" value="<?php if($data['mode']=='com_reg') {echo set_value('calc_mail2');} else {$a = explode('@', $data['com']->calc_mail); echo $a[1];} ?>" required>
							</div>
							<div class="col-xs-3" style="padding-right: 0;">
								...
								<tr>
									<td class="col-xs-2" style="padding: 0;">
										<div class="col-xs-11 input-group">
											<input type="text" class="form-control input-sm" id="tax_off1_code" name="tax_off1_code" value="<?php if($data['mode']=='com_reg') {echo set_value('tax_off1_code');} else {echo $data['com']->tax_off1_code; } ?>" readonly required>
									...
									<td class="col-xs-3" style="padding: 0;">
										<div class="col-xs-10" style="padding-left: 0;">
											...
											<input type="text" class="form-control input-sm" id="tax_off1_name" name="tax_off1_name" value="<?php if($data['mode']=='com_reg') {echo set_value('tax_off1_name');} else {echo $data['com']->tax_off1_name; } ?>" readonly required>
										</div>
									</td>
								</tr>
							</table>
						...
						<div class="form-inline col-xs-12 col-sm-8 col-md-4 form-wrap" style="padding-left: 15px;">
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td class="col-xs-2" style="padding: 0;">
										<div class="col-xs-11  input-group">
											<input type="text" class="form-control input-sm" id=tax_off2_code"" name="tax_off2_code" value="<?php if($data['mode']=='com_reg') {echo set_value('tax_off2_code');} else if($data['com']->tax_off2_code>0) {echo $data['com']->tax_off2_code; } ?>" readonly>
											<span class="input-group-btn">
									...
									<td class="col-xs-3" style="padding: 0;">
										<div class="col-xs-10" style="padding-left: 0;">
											...
											<input type="text" class="form-control input-sm" id="tax_off2_name" name="tax_off2_name" value="<?php if($data['mode']=='com_reg') {echo set_value('tax_off2_name');} else {echo $data['com']->tax_off2_name; } ?>" readonly>
										</div>
									</td>
								</tr>
							</table>
					...
					<div class="form-group bo-top" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-10 form-wrap">
							...
							<div class="col-xs-12 col-sm-6 col-md-4" style="padding-right: 0;">
								...
								<input type="text" class="form-control input-sm" id="address1_1" name="address1_1" maxlength="100" value="<?php if($data['mode']=='com_reg') {echo set_value('address1');} else {echo $data['com']->address1; } ?>" readonly required>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-3" style="padding-right: 0;">
								<label for="address2_1" class="sr-only">회사주소2</label>
								<input type="text" class="form-control input-sm" id="address2_1" name="address2_1" maxlength="100" value="<?php if($data['mode']=='com_reg') {echo set_value('address2');} else {echo $data['com']->address2; } ?>" name="address2">
							</div>
					...
					<div class="form-group bo-top" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-10 form-wrap">
							<div class="col-md-6 col-xs-12" style="padding-right: 0;"><input type="text" class="form-control input-sm en_only" id="en_co_name" name="en_co_name" maxlength="50" value="<?php if($data['mode']=='com_reg') {echo set_value('en_co_name');} else {echo $data['com']->en_co_name; } ?>"></div>
					...
					<div class="form-group pb20" style="margin: 0;">
						...
						<div class="col-xs-12 col-sm-8 col-md-10 form-wrap">
							<div class="col-md-10 col-xs-12"><input type="text" class="form-control input-sm wid-100 en_only" id="addressEnglish" name="addressEnglish" maxlength="200"  value="<?php if($data['mode']=='com_reg') {echo set_value('en_address');} else {echo $data['com']->en_address; } ?>"></div>
							<div class="col-md-2">&nbsp;</div>
							<div class="col-xs-12">상세주소, 번지(number), 거리(street), 시군구(city), 광역시도(state), 국가(country) 순으로 기재</div>
							<div><?php echo validation_errors(); ?></div>
						</div>
					</div>
<?php if($data['auth21']<2) {$submit_str="alert('등록 권한이 없습니다!')";} else {$submit_str="com_submit('".$data['mode']."');";} ?>
					<div class="form-group btn-wrap" style="margin: 0;">
						<input type="button" class="btn btn-primary btn-sm" onclick="<?=$submit_str?>" value="<?php if($data['mode']=='com_reg') echo '등록'; else echo '수정' ?>하기">
					</div>
