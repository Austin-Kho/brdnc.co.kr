...
?>
							<div class="bg-success col-md-2" style="height: 40px; padding-top: 10px;">은행별</div>
							...
							<div class="row bo-top">
								...
								<div class="col-xs-8 col-sm-8 col-md-4 form-wrap2">
									<div class="col-xs-7 col-md-5" style="padding-left: 0;">
										<select class="form-control input-sm" name="bank" onchange="this.form.bank_code.value=this.value;" autofocus>
											<option value=''>전 체</option>
