<ul class="nav nav-tabs" role="tablist">
  <?php for ($i = 0; $i < count($sec_menu); $i++) : ?>
    <li role="presentation" class="<? if ((!$this->uri->segment(3) && $i === 0) or $this->uri->segment(3) === (string)($i + 1)) echo 'active';
                                    else echo ''; ?>">
    ...
    <?php if (!$this->uri->segment(3) or $this->uri->segment(3) == 1) :
      ...
      for ($i = 0; $i < $len; $i++) :
        ...
        <li role="presentation" class="<?php if ((!$this->uri->segment(4) && $j == 1) or $this->uri->segment(4) == $j) echo 'active'; ?>">
          <a href="<?php echo $this->config->base_url('cms_m2/process'); ?>/<?php if ($this->uri->segment(3)) {
...
<div class="page-header sdi_sub">
  ...
  <h4 class="sdi">
    ...
    switch ($this->uri->segment(4)): case '1':
        echo $s_di[$k][0];
        break;
      case '2':
        echo $s_di[$k][1];
