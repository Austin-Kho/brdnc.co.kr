...
if ($auth11 < 1) :
    ...
    <div class="row bo-top bo-bottom" style="margin: 0 0 20px 0;">
        ...
        ?>
        <div class="col-xs-5 col-sm-2 center bg-success" style="padding: 11px;">회사 정보</div>
        <div class="col-xs-7 col-sm-4" style="padding: 5px;">
            <div class="col-sm-8" style="padding: 0;">
                <select class="form-control input-sm" name="com_sel" onchange="submit();">
                    <option value='0'>선 택</option>
                    <?php foreach ($com_list as $lt) : ?>
                        <option value="<?php echo $lt->seq; ?>" <? if ($lt->seq == $this->input->post('com_sel')) echo "selected"; ?>><?php echo $lt->co_name; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>

        <div class="col-xs-5 col-sm-2 center bg-success" style="padding: 11px;">날 짜</div>
        <div class="col-xs-7 col-sm-4" style="padding: 5px;">
                ...
                <table class="table table-bordered table-hover table-condensed font12">
                    ...
                    <?php for ($i = 0; $i <= $bank_acc['num']; $i++) : // 현금계정 + 은행계좌 수 만큼 반복 한다.
                        ...
                        <tr>
                            ...
                            <td class="right" style="<?php if ($i == 0) echo $hk_bgcolor ?>"><?php if ($i == $bank_acc['num']) echo '';
