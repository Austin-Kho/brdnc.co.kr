    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row bo-top bo-bottom" style="margin: 0 0 20px 0;">
                ...
                <div class="col-xs-12 col-md-2 center bg-success" style="padding: 12px;">거래기간</div>
                <div class="col-xs-7 col-md-3" style="padding: 6px;">
                    <div class="col-xs-5" style="padding: 0px;">
                        <label for="s_date" class="sr-only">시작일</label>
                        <div>
                            <input type="text" class="form-control input-sm wid-95" id="s_date" name="s_date"
                                   maxlength="10"
                                   value="<?php if ( $this->input->get ( 's_date' ) ) echo $this->input->get ( 's_date' ); ?>"
                                   readonly onClick="cal_add(this); event.cancelBubble=true" placeholder="시작일">
                        </div>
                    </div>
                    <div class="col-xs-1 glyphicon-wrap" style="padding: 6px 0;">
                        <a href="javascript:"
                           onclick="cal_add(document.getElementById('s_date'),this); event.cancelBubble=true">
                    ...
                    <div class="col-xs-5" style="padding: 0px;">
                        ...
                        <div>
                            <input type="text" class="form-control input-sm wid-95" id="e_date" name="e_date"
                                   maxlength="10"
                                   value="<?php if ( $this->input->get ( 'e_date' ) ) echo $this->input->get ( 'e_date' ); ?>"
                                   readonly onClick="cal_add(this); event.cancelBubble=true" placeholder="종료일">
                        </div>
                    </div>
                    <div class="col-xs-1 glyphicon-wrap" style="padding: 6px 0;">
                        <a href="javascript:"
                           onclick="cal_add(document.getElementById('e_date'),this); event.cancelBubble=true">
                            <span class="glyphicon glyphicon-calendar" aria-hidden="true" id="glyphicon"></span>
                        </a>
                    </div>
                </div>

                <div class="col-xs-5 col-md-2" style="padding: 11px 0px; text-align: right;">
                    <a href="javascript:" onclick="term_put('s_date', 'e_date', 'd');" title="오늘"><img
                                src="<?php echo base_url (); ?>static/img/to_today.jpg" alt="오늘"></a>
                    <a href="javascript:" onclick="term_put('s_date', 'e_date', 'w');" title="일주일"><img
                                src="<?php echo base_url (); ?>static/img/to_week.jpg" alt="일주일"></a>
                    <a href="javascript:" onclick="term_put('s_date', 'e_date', 'm');" title="1개월"><img
                                src="<?php echo base_url (); ?>static/img/to_month.jpg" alt="1개월"></a>
                    <a href="javascript:" onclick="term_put('s_date', 'e_date', '3m');" title="3개월"><img
                                src="<?php echo base_url (); ?>static/img/to_3month.jpg" alt="3개월"></a>
                    <button type="button" class="close" aria-label="Close" style="padding-left: 2px;"
                            onclick="document.getElementById('s_date').value=''; document.getElementById('e_date').value='';">
                        <span aria-hidden="true">&times;</span></button>
                </div>

                <div class="col-xs-4 col-md-2 center bg-success" style="padding: 12px;">구 분</div>
                <div class="col-xs-8 col-md-3" style="padding: 6px;">
                    <div class="col-xs-6" style="padding: 0px;">
                        ...
                        <select class="form-control input-sm" name="class1" onChange="inoutSel(this.form);">
                            <option value="0">선 택</option>
                            <option value="1" <?php if ( $this->input->get ( 'class1' ) == 1 ) echo 'selected'; ?>>입 금
                            </option>
                            <option value="2" <?php if ( $this->input->get ( 'class1' ) == 2 ) echo 'selected'; ?>>출 금
                            </option>
                            <option value="3" <?php if ( $this->input->get ( 'class1' ) == 3 ) echo 'selected'; ?>>대 체
                            </option>
                        </select>
                    </div>
                    <div class="col-xs-6" style="padding: 0 6px;">
                        <label for="class2" class="sr-only">구분2</label>
                        <select class="form-control input-sm" name="class2"
                                onchange="inoutSel2(this.form)" <? if ( !$this->input->get ( 'class1' ) && !$this->input->get ( 'class2' ) ) echo "disabled"; ?>>
                            <?php if ( !$this->input->get ( 'class1' ) or !$this->input->get ( 'class2' ) ) : ?>
                                <option value="0"> 선 택</option>
                            <?php elseif ( $this->input->get ( 'class1' ) == 1 ) : ?>
                                <option value="0"> 선 택</option>
                                <option value="1" <? if ( $this->input->get ( 'class2' ) == 1 ) echo "selected"; ?>> 자 산
                                </option>
                                <option value="2" <? if ( $this->input->get ( 'class2' ) == 2 ) echo "selected"; ?>> 부 채
                                </option>
                                <option value="3" <? if ( $this->input->get ( 'class2' ) == 3 ) echo "selected"; ?>> 자 본
                                </option>
                                <option value="4" <? if ( $this->input->get ( 'class2' ) == 4 ) echo "selected"; ?>> 수 익
                                </option>
                            <?php elseif ( $this->input->get ( 'class1' ) == 2 ) : ?>
                                ...
                                <option value="5" <? if ( $this->input->get ( 'class2' ) == 5 ) echo "selected"; ?>> 비 용
                                </option>
                            <?php elseif ( $this->input->get ( 'class1' ) == 3 ) : ?>
                                <option value="0"> 선 택</option>
                                <option value="6" <? if ( $this->input->get ( 'class2' ) == 6 ) echo "selected"; ?>> 본 사
                                </option>
                                <option value="7" <? if ( $this->input->get ( 'class2' ) == 7 ) echo "selected"; ?>> 현 장
                                </option>
                            <?php endif; ?>
                        </select>
                    </div>
                ...
                <div class="col-xs-4 col-md-2 center bg-success" style="padding: 6px;">
                    <label for="search_con" class="sr-only">검색조건</label>
                    <select class="form-control input-sm" name="search_con">
                        <option value="0">통합검색</option>
                        <option value="1" <?php if ( $this->input->get ( 'search_con' ) == 1 ) echo 'selected'; ?>>
                            계정과목
                        </option>
                        <option value="2" <?php if ( $this->input->get ( 'search_con' ) == 2 ) echo 'selected'; ?>>적 요
                        </option>
                        <option value="3" <?php if ( $this->input->get ( 'search_con' ) == 3 ) echo 'selected'; ?>>거래처
                        </option>
                        <option value="4" <?php if ( $this->input->get ( 'search_con' ) == 4 ) echo 'selected'; ?>>
                            입출금처
                        </option>
                    </select>
                </div>
                <div class="col-xs-6 col-md-4" style="height: 40px; padding: 5px 0 0 5px;">
                    <label for="search_text" class="sr-only">검색어</label>
                    <input type="text" name="search_text"
                           value="<?php if ( $this->input->get ( 'search_text' ) ) echo $this->input->get ( 'search_text' ); ?>"
                           class="form-control input-sm" placeholder="검색어" onkeydown="if(event.keyCode==13)submit();">
                </div>
                <div class="col-xs-2 col-md-1 center" style="height: 40px; padding: 3px;">
            ...
            <div class="row table-responsive" style="margin: 0;">
                <table class="table table-bordered table-hover table-condensed font12">
                    ...
                    <tr style="border-top: 1px solid #ddd; background-color: #EAEAEA;">
                        ...
                        <?php if ($auth12 > 1) : ?><!-- //마스터 관리자와 쓰기권한 있는 자금담당에게만 출력 -->
                    ...
                    <?php foreach ($cb_list as $lt) : ?>
                        ...
                        <?php if ( $lt->account == "" || $lt->account == '0' ) {
                            $account = "-";
                        } else {
                            $account = "[" . $lt->account . "]";
                        } //계정과목
                        ...
                        if ( $lt->inc == 0 || ($lt->class1 == 3 && $lt->out_acc == $lt->no) ) {
                            $inc = "-";
                        } else {
                            $inc = number_format ( $lt->inc );
                        }// 수입금
                        // 지출금이 '0' 이거나 대체거래이고 입금계정이 은행등록계좌와 같으면,
                        if ( $lt->exp == 0 || ($lt->class1 == 3 && $lt->in_acc == $lt->no) ) {
                            $exp = "-";
                        } else {
                            $exp = number_format ( $lt->exp );
                        }// 지출금
                        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        if ( $lt->in_acc == 0 || ($lt->class1 == 3 && $lt->out_acc == $lt->no) ) {
                            $in_acc = "";
                        } else {
                            $in_acc = $lt->name;
                        } // 입금계정은 계좌별칭
                        // 출금계정정보가 없거나 대체거래이고 입금계정이 은행등록계좌와 같으면,
                        if ( $lt->out_acc == 0 || ($lt->class1 == 3 && $lt->in_acc == $lt->no) ) {
                            $out_acc = "";
                        } else {
                            $out_acc = $lt->name;
                        } // 출금계정은 계좌별칭
                        ...
                        <tr>
                            ...
                            <td class="">
                                <div data-toggle="tooltip" data-placement="right"
                                     title="<?php echo $lt->cont . $memo; ?>"
                                     style="cursor: pointer;"><?php echo cut_string ( $lt->cont, 15, '..' ); ?></div>
                            </td>
                            <td class="">
                                <div data-toggle="tooltip" data-placement="right"
                                     title="<?php echo $lt->acc . $memo; ?>"
                                     style="cursor: pointer;"><?php echo cut_string ( $acc, 7, '..' ); ?>
                            </td>
                            ...
                            <?php if ($auth12 > 1) : ?><!-- //마스터 관리자와 쓰기권한 있는 자금담당에게만 출력 -->
                            <td class="center">
                                <?php if ($m_auth->mem_is_admin === '1' or $m_auth->mem_level >= 60 or ($m_auth->mem_level < 60 && date ( 'Y-m-d', strtotime ( '-3 day' ) ) <= $lt->deal_date)) : //관리자와 마스터 쓰기권한이 아니면 최근 3일전 건에 대해서만 수정 가능   ?>
                                <a href='javascript:' class="btn btn-info btn-xs"
                                   onclick="popUp_size('<?php echo base_url ( '/cms_popup/Capital_cash_book/cash_book/' . $lt->seq_num ); ?>','cash_book','500','670')">
                                    <?php else: ?>
                                    <a href="javascript:" class="btn btn-default btn-xs"
                                       onclick="alert('마스터 관리자가 아니면 3일전 이후 건에 대해서만 수정 가능합니다.\n\n수정 필요 시 마스터 관리자에게 요청하여 주십시요.');">
                                        <?php endif; ?>
                                        수정</a>
                            </td>
                            <td class="center">
