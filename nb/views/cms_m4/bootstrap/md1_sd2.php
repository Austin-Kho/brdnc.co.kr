...
?>
							<div class="col-xs-12 col-sm-2 col-md-1 center bg-success" style="height: 40px; padding: 10px 0;">구 분</div>
...
<?php endif;?>
							...
							<div class="col-xs-12 col-sm-2 col-md-1 center bg-success" style="height: 40px; padding: 10px 0;">거래기간</div>
                  ...
                  <div>
                    <input type="text" class="form-control input-sm wid-95" id="e_date" name="e_date" maxlength="10" value="<?php if($this->input->get('e_date')) echo $this->input->get('e_date'); ?>" readonly onClick="cal_add(this); event.cancelBubble=true" placeholder="종료일">
							...
							<div class="col-xs-5 col-sm-2 col-md-1 center bg-success" style="height: 40px; padding: 5px;">
...
?>
								<tr>
									...
									<td class=""><div data-toggle="tooltip" data-placement="right" title="<?php echo $lt->cont.$memo; ?>" style="cursor: pointer;"><?php echo cut_string($lt->cont, 15, '..'); ?></div></td>
