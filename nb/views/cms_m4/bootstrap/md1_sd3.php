...
<?php endforeach; ?>
								...
								<!-- 입금금액 _1 -->
								<td class="center"><input type="number" name="inc_1" id="inc_1" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_1,this,document.inout_frm.exp_1)"></td>
								<!--출금처 _1 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _1 -->
								<td class="center"><input type="number" name="exp_1" id="exp_1" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _1 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_1" onclick="char2_chk(document.inout_frm.char2_1,1);" disabled>금액:</label> <input type="number" name="char2_1" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _1 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 입금금액 _2 -->
								<td class="center"><input type="number" name="inc_2" id="inc_2" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_2,this,document.inout_frm.exp_2)"></td>
								<!--출금처 _2 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _2 -->
								<td class="center"><input type="number" name="exp_2" id="exp_2" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _2 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_2" onclick="char2_chk(document.inout_frm.char2_2,2);" disabled>금액:</label> <input type="number" name="char2_2" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _2 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 입금금액 _3 -->
								<td class="center"><input type="number" name="inc_3" id="inc_3" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_3,this,document.inout_frm.exp_3)"></td>
								<!--출금처 _3 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _3 -->
								<td class="center"><input type="number" name="exp_3" id="exp_3" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _3 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_3" onclick="char2_chk(document.inout_frm.char2_3,3);" disabled>금액:</label> <input type="number" name="char2_3" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _3 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 입금금액 _4 -->
								<td class="center"><input type="number" name="inc_4" id="inc_4" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_4,this,document.inout_frm.exp_4)"></td>
								<!--출금처 _4 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _4 -->
								<td class="center"><input type="number" name="exp_4" id="exp_4" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _4 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_4" onclick="char2_chk(document.inout_frm.char2_4,4);" disabled>금액:</label> <input type="number" name="char2_4" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _4 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 입금금액 _5 -->
								<td class="center"><input type="number" name="inc_5" id="inc_5" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_5,this,document.inout_frm.exp_5)"></td>
								<!--출금처 _5 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _5 -->
								<td class="center"><input type="number" name="exp_5" id="exp_5" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _5 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_5" onclick="char2_chk(document.inout_frm.char2_5,5);" disabled>금액:</label> <input type="number" name="char2_5" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _5 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 입금금액 _6 -->
								<td class="center"><input type="number" name="inc_6" id="inc_6" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_6,this,document.inout_frm.exp_6)"></td>
								<!--출금처 _6 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _6 -->
								<td class="center"><input type="number" name="exp_6" id="exp_6" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _6 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_6" onclick="char2_chk(document.inout_frm.char2_6,6);" disabled>금액:</label> <input type="number" name="char2_6" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _6 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 입금금액 _7 -->
								<td class="center"><input type="number" name="inc_7" id="inc_7" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_7,this,document.inout_frm.exp_7)"></td>
								<!--출금처 _7 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _7 -->
								<td class="center"><input type="number" name="exp_7" id="exp_7" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _7 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_7" onclick="char2_chk(document.inout_frm.char2_7,7);" disabled>금액:</label> <input type="number" name="char2_7" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _7 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 입금금액 _8 -->
								<td class="center"><input type="number" name="inc_8" id="inc_8" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_8,this,document.inout_frm.exp_8)"></td>
								<!--출금처 _8 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _8 -->
								<td class="center"><input type="number" name="exp_8" id="exp_8" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _8 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_8" onclick="char2_chk(document.inout_frm.char2_8,8);" disabled>금액:</label> <input type="number" name="char2_8" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _8 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 입금금액 _9 -->
								<td class="center"><input type="number" name="inc_9" id="inc_9" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_9,this,document.inout_frm.exp_9)"></td>
								<!--출금처 _9 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _9 -->
								<td class="center"><input type="number" name="exp_9" id="exp_9" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _9 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_9" onclick="char2_chk(document.inout_frm.char2_9,9);" disabled>금액:</label> <input type="number" name="char2_9" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _9 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 입금금액 _10 -->
								<td class="center"><input type="number" name="inc_10" id="inc_10" size="10" onkeyPress ='iNum(this)' onChange="transfer(document.inout_frm.class1_10,this,document.inout_frm.exp_10)"></td>
								<!--출금처 _10 -->
								<td class="center" style=" padding-top: 7px;">
...
<?php endforeach; ?>
								...
								<!-- 출금금액 _10 -->
								<td class="center"><input type="number" name="exp_10" id="exp_10" size="10" onkeyPress ='iNum(this)'></td>
								<!-- 수수료 _10 -->
								<td class="center" style="padding: 5px 0 0 0;"><div class="checkbox" style="margin:0;"><label><div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_10" onclick="char2_chk(document.inout_frm.char2_10,10);" disabled>금액:</label> <input type="number" name="char2_10" size="3" onkeyPress ='iNum(this)' disabled></div></td>
								<!-- 증빙서류 _10 -->
								<td class="center" style=" padding-top: 7px;">
