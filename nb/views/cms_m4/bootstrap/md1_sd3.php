...
if ( $auth13 < 1 ) :
    ...
    <div class="row bo-top bo-bottom" style="margin: 0 0 20px 0;">
        ...
        <div class="col-xs-4 col-md-2 center bg-success" style="padding: 12px;">거래일자</div>
        <div class="col-xs-8 col-md-2" style=" padding: 5px;">
            <div class="col-xs-12" style="padding: 1px 0px;">
                <label for="deal_date" class="sr-only">입력일</label>
                <div class="input-group">
                    <input type="text" class="form-control input-sm wid-95" id="deal_date" name="deal_date"
                           maxlength="10" value="<?php echo date ( 'Y-m-d' ) ?>"
                           onClick="cal_add(this); event.cancelBubble=true">
                    <span class="input-group-addon">
                  <a href="javascript:"
                     onclick="cal_add(document.getElementById('deal_date'),this); event.cancelBubble=true">
        ...
        <div class="col-xs-4 col-md-2 center bg-success" style="padding: 12px;">입력직원</div>
        <div class="col-xs-8 col-md-2 center"
             style="line-height: 38px;"><?php echo $this->session->userdata['mem_username']; ?></div>
    </div>
    ...
    <div class="row table-responsive" style="margin: 0;">
        <table class="table table-condensed table-hover font12">
            ...
            <tr style="background-color: #EAEAEA;">
                ...
                <th style="width:85px;  padding:8px 0;" class="center">계정과목 <font color="red">*</font> <a
                            href="javascript:"
                            onclick="popUp_size('<?php echo base_url ( 'cms_popup/capital_account' ); ?>','account',700,800)"
                            title="계정과목 관리"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span></a></th>
                ...
                <th style="width:65px; padding:8px 0;" class="center">입금처 <font color="red">*</font> <a
                            href="javascript:"
                            onclick="popUp('<?php echo base_url ( 'cms_popup/capital_acc_add' ); ?>?fn=1&amp;frm=out_stock_frm','bank_acc')"
                            title="은행계좌 관리"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span></a></th>
                <th style="width:75px; padding:8px 0;" class="center">입금금액 <font color="red">*</font></th>
                <th style="width:65px; padding:8px 0;" class="center">출금처 <font color="red">*</font> <a
                            href="javascript:"
                            onclick="popUp('<?php echo base_url ( 'cms_popup/capital_acc_add' ); ?>?fn=1&amp;frm=out_stock_frm','bank_acc')"
                            title="은행계좌 관리"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span></a></th>
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_1" id="class2_1" style="width:62px;" onChange="inoutSel2(this.form, 1)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <td class="center" style="padding: 0;">
                    <div class="checkbox" style="margin:0; padding-top:7px;"><label><input type="checkbox" value="1"
                                                                                           name="jh_loan_1"
                                                                                           id="jh_loan_1"
                                                                                           onClick="jh_chk(1);"
                                                                                           disabled>:조합</label></div>
                </td>
                <!-- 현장코드 _1 -->
                <td class="center" style="padding: 7px 0;">
                ...
                <!-- 입금금액 _1 -->
                <td class="center"><input type="number" name="inc_1" id="inc_1" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_1,this,document.inout_frm.exp_1)">
                </td>
                <!--출금처 _1 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _1 -->
                <td class="center"><input type="number" name="exp_1" id="exp_1" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _1 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_1"
                                                                                  onclick="char2_chk(document.inout_frm.char2_1,1);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_1" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _1 -->
                <td class="center" style=" padding-top: 7px;">
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_2" id="class2_2" style="width:62px;" onChange="inoutSel2(this.form, 2)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <!-- 입금금액 _2 -->
                <td class="center"><input type="number" name="inc_2" id="inc_2" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_2,this,document.inout_frm.exp_2)">
                </td>
                <!--출금처 _2 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _2 -->
                <td class="center"><input type="number" name="exp_2" id="exp_2" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _2 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_2"
                                                                                  onclick="char2_chk(document.inout_frm.char2_2,2);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_2" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _2 -->
                <td class="center" style=" padding-top: 7px;">
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_3" id="class2_3" style="width:62px;" onChange="inoutSel2(this.form, 3)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <!-- 입금금액 _3 -->
                <td class="center"><input type="number" name="inc_3" id="inc_3" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_3,this,document.inout_frm.exp_3)">
                </td>
                <!--출금처 _3 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _3 -->
                <td class="center"><input type="number" name="exp_3" id="exp_3" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _3 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_3"
                                                                                  onclick="char2_chk(document.inout_frm.char2_3,3);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_3" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _3 -->
                <td class="center" style=" padding-top: 7px;">
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_4" id="class2_4" style="width:62px;" onChange="inoutSel2(this.form, 4)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <!-- 입금금액 _4 -->
                <td class="center"><input type="number" name="inc_4" id="inc_4" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_4,this,document.inout_frm.exp_4)">
                </td>
                <!--출금처 _4 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _4 -->
                <td class="center"><input type="number" name="exp_4" id="exp_4" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _4 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_4"
                                                                                  onclick="char2_chk(document.inout_frm.char2_4,4);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_4" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _4 -->
                <td class="center" style=" padding-top: 7px;">
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_5" id="class2_5" style="width:62px;" onChange="inoutSel2(this.form, 5)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <!-- 입금금액 _5 -->
                <td class="center"><input type="number" name="inc_5" id="inc_5" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_5,this,document.inout_frm.exp_5)">
                </td>
                <!--출금처 _5 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _5 -->
                <td class="center"><input type="number" name="exp_5" id="exp_5" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _5 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_5"
                                                                                  onclick="char2_chk(document.inout_frm.char2_5,5);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_5" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _5 -->
                <td class="center" style=" padding-top: 7px;">
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_6" id="class2_6" style="width:62px;" onChange="inoutSel2(this.form, 6)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <!-- 입금금액 _6 -->
                <td class="center"><input type="number" name="inc_6" id="inc_6" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_6,this,document.inout_frm.exp_6)">
                </td>
                <!--출금처 _6 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _6 -->
                <td class="center"><input type="number" name="exp_6" id="exp_6" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _6 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_6"
                                                                                  onclick="char2_chk(document.inout_frm.char2_6,6);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_6" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _6 -->
                <td class="center" style=" padding-top: 7px;">
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_7" id="class2_7" style="width:62px;" onChange="inoutSel2(this.form, 7)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <!-- 입금금액 _7 -->
                <td class="center"><input type="number" name="inc_7" id="inc_7" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_7,this,document.inout_frm.exp_7)">
                </td>
                <!--출금처 _7 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _7 -->
                <td class="center"><input type="number" name="exp_7" id="exp_7" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _7 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_7"
                                                                                  onclick="char2_chk(document.inout_frm.char2_7,7);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_7" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _7 -->
                <td class="center" style=" padding-top: 7px;">
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_8" id="class2_8" style="width:62px;" onChange="inoutSel2(this.form, 8)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <!-- 입금금액 _8 -->
                <td class="center"><input type="number" name="inc_8" id="inc_8" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_8,this,document.inout_frm.exp_8)">
                </td>
                <!--출금처 _8 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _8 -->
                <td class="center"><input type="number" name="exp_8" id="exp_8" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _8 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_8"
                                                                                  onclick="char2_chk(document.inout_frm.char2_8,8);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_8" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _8 -->
                <td class="center" style=" padding-top: 7px;">
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_9" id="class2_9" style="width:62px;" onChange="inoutSel2(this.form, 9)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <!-- 입금금액 _9 -->
                <td class="center"><input type="number" name="inc_9" id="inc_9" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_9,this,document.inout_frm.exp_9)">
                </td>
                <!--출금처 _9 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _9 -->
                <td class="center"><input type="number" name="exp_9" id="exp_9" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _9 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_9"
                                                                                  onclick="char2_chk(document.inout_frm.char2_9,9);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_9" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _9 -->
                <td class="center" style=" padding-top: 7px;">
            ...
            <tr>
                ...
                <td class="center" style="padding: 7px 0;">
                    ...
                    <select name="class2_10" id="class2_10" style="width:62px;" onChange="inoutSel2(this.form, 10)"
                            disabled>
                        <option value="" selected> 선 택
                        <option value="1"> 자 산
                        <option value="2"> 부 채
                ...
                <!-- 입금금액 _10 -->
                <td class="center"><input type="number" name="inc_10" id="inc_10" style="width:80px;"
                                          onkeyPress='iNum(this)'
                                          onChange="transfer(document.inout_frm.class1_10,this,document.inout_frm.exp_10)">
                </td>
                <!--출금처 _10 -->
                <td class="center" style=" padding-top: 7px;">
                ...
                <!-- 출금금액 _10 -->
                <td class="center"><input type="number" name="exp_10" id="exp_10" style="width:80px;"
                                          onkeyPress='iNum(this)'></td>
                <!-- 수수료 _10 -->
                <td class="center" style="padding: 5px 0 0 0;">
                    <div class="checkbox" style="margin:0;"><label>
                            <div class="checkbox" style="margin:0;"><label><input type="checkbox" name="char1_10"
                                                                                  onclick="char2_chk(document.inout_frm.char2_10,10);"
                                                                                  disabled>금액:</label> <input
                                        type="text" name="char2_10" size="3" onkeyPress='iNum(this)' disabled></div>
                </td>
                <!-- 증빙서류 _10 -->
                <td class="center" style=" padding-top: 7px;">
