...
?>
			<div class="row bo-top bo-bottom font12" style="margin: 0 0 20px 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-success" style="padding: 10px;">사업 개시년도</div>
...
<?php endfor; ?>
				...
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-success" style="padding: 10px;">프로젝트 선택 </div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
<?php endforeach; ?>
			...
			<div class="row bo-top bo-bottom font12" style="margin: 0;">
				<div class="row bo-bottom font12" style="margin: 0;">
					<div class="col-xs-4 col-sm-3 col-md-2 center bg-info" style="padding: 10px 0;">처리 구분 <span class="red">*</span></div>
					<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					...
					<div class="col-xs-4 col-sm-3 col-md-2 center bg-info" style="padding: 10px;">등록 구분 <span class="red">*</span></div>
	...
	<?php endif; ?>
				...
				<div class="row bo-bottom font12" style="margin: 0;">
					<div class="col-xs-4 col-sm-3 col-md-2 center bg-info" style="padding: 10px;">차수 구분 <span class="red">*</span></div>
					<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
						<div class="col-xs-12" style="padding: 0px;">
...
?>
	...
	<?php endforeach; ?>
					...
					<div class="col-xs-4 col-sm-3 col-md-2 center bg-info" style="padding: 10px;">타입 선택 <span class="red">*</span></div>
					<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
						<div class="col-xs-12" style="padding: 0px;">
...
<?php endforeach; ?>
				...
				<div class="row bo-bottom font12" style="margin: 0 0 15px;">
					<div class="col-xs-4 col-sm-3 col-md-2 center bg-info" style="padding: 10px;">동 선택 <span class="red">*</span></div>
					<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
						<div class="col-xs-12" style="padding: 0px;">
	...
	<?php endforeach; ?>
					...
					<div class="col-xs-4 col-sm-3 col-md-2 center bg-info" style="padding: 10px;">호수 선택 <span class="red">*</span></div>
					<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
						<div class="col-xs-12" style="padding: 0px;">
...
<?php if($this->input->get('cont_sort2')=="1" && !empty($is_reg['app_data'])) : // 청약 등록 호수인 경우 ?>
			<div class="row bo-top font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">구 분</div>
...
<?php if( !empty($is_reg['app_data'])) $dicol = "#eefb86;"; if( !empty($is_reg['cont_data'])) $dicol = "#bee3b1;";   ?>
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="height: 60px; padding: 10px;">현재 상태 <span class="red">*</span></div>
...
?>
			<div class="row bo-top font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;"><?php echo $conclu_date_label; ?> <span class="red">*</span></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
?>
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">계약 예정일</div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
?>
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px; ">계약 일련번호</div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
<?php endif; ?>
			...
			<div class="row bo-top bo-bottom font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">계약 고객명 <span class="red">*</span></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
<?php
...
<?php if( !$this->input->get('cont_sort2') or $this->input->get('cont_sort2')==1 or $this->input->get('cont_sort3')==3) : ?>
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">&nbsp;</span></div>
<?php elseif($this->input->get('cont_sort2')==2 or $this->input->get('cont_sort3')==4) : ?>
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">생년 월일 <span class="red">*</span></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
				...
				<div class="visible-xs visible-sm col-xs-4  col-sm-3 center bg-warning" style="padding: 10px;">성 별 <span class="red">*</span></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
...
?>
			<div class="row bo-bottom font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">연락처 [1] <span class="red">*</span></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
				...
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">연락처 [2]</div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
<?php if( !($this->input->get('cont_sort2')=='2' && empty($is_app_cont) && empty($is_reg['app_data']))): // 계약등록 시 청약 데이터가 없는 신규 등록인 경우만 제외하고 ->?>
			<div class="row bo-bottom font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">청약금 <span class="red">*</span>
					<div class="bg-warning hidden-md hidden-lg" style="height: 153px;">&nbsp;</div>
				</div>
<?php
...
<?php if($this->input->get('cont_sort2')=="2" OR $this->input->get('cont_sort3')==4) : // 계약 등록 시 ?>
			<div class="row bo-bottom font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">계약금 [1] <span class="red">*</span>
					<div class="bg-warning hidden-md hidden-lg" style="height: 153px;">&nbsp;</div>
				</div>
<?php
...
?>
			<div class="row bo-bottom font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">계약금 [2] &nbsp;
				<div class="bg-warning hidden-md hidden-lg" style="height: 153px;">&nbsp;</div></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
?>
			<div class="row bo-bottom font12" id="rec_3" style="margin: 0; <?php if($rec_num<3) echo "display:none";?>">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">계약금 [3] &nbsp;
				<div class="bg-warning hidden-md hidden-lg" style="height: 153px;">&nbsp;</div></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
?>
			<div class="row bo-bottom font12" id="rec_4" style="margin: 0; <?php if($rec_num<4) echo "display:none";?>">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">계약금 [4] &nbsp;
				<div class="bg-warning hidden-md hidden-lg" style="height: 153px;">&nbsp;</div></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
?>
			<div class="row bo-bottom font12" id="rec_5" style="margin: 0; <?php if($rec_num<5) echo "display:none";?>">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">계약금 [5] &nbsp;
				<div class="bg-warning hidden-md hidden-lg" style="height: 153px;">&nbsp;</div></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
?>
			<div class="row bo-bottom font12" id="rec_6" style="margin: 0; <?php if($rec_num<6) echo "display:none";?>">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">계약금 [6] &nbsp;
				<div class="bg-warning hidden-md hidden-lg" style="height: 153px;">&nbsp;</div></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
?>
			<div class="row bo-bottom font12" id="rec_7" style="margin: 0; <?php if($rec_num<7) echo "display:none";?>">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">계약금 [7] &nbsp;
				<div class="bg-warning hidden-md hidden-lg" style="height: 153px;">&nbsp;</div></div>
				<div class="col-xs-8 col-sm-9 col-md-2" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
...
<?php if( !empty($is_reg['cont_data'])) $addr1 = explode("|", $is_reg['cont_data']->cont_addr1); ?>
			<div class="row bo-bottom font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">주민등록 주소 <span class="red">*</span>
...
<?php if( !empty($is_reg['cont_data'])) $addr2 = explode("|", $is_reg['cont_data']->cont_addr2); ?>
			<div class="row bo-bottom font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">우편송부 주소  <span class="red">*</span>
					<div class="visible-xs" style="height: 39px;">&nbsp;</div>
			...
			<div class="row bo-bottom font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;">미비서류 항목
...
?>
			<div class="row bo-bottom font12" style="margin: 0;">
				<div class="col-xs-4 col-sm-3 col-md-2 center bg-warning" style="padding: 10px;; height: 75px;">비 고</div>
				<div class="col-xs-8 col-sm-9 col-md-8" style="padding: 4px 15px;">
					<div class="col-xs-12" style="padding: 0px;">
