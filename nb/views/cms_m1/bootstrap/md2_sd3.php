...
?>
			<div class="col-xs-4 col-sm-3 col-md-2 center bg-info" style="line-height:38px;">사업 개시년도</div>
...
<?php endfor; ?>
			...
			<div class="col-xs-4 col-sm-3 col-md-2 center bg-info" style="line-height:38px;">프로젝트 선택 </div>
			<div class="col-xs-8 col-sm-9 col-md-4" style="padding: 4px 15px;">
				<div class="col-xs-12 col-sm-8" style="padding: 0px;">
