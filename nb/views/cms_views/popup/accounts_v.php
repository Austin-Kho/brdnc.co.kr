		...
		<div class="row">
			...
			<div class="well" style="padding: 13px; margin-bottom: 20px;">※ 검색할 계정과목 명칭을 선택하여 주십시요.</div>
				<div class="row" style="padding-top:0;">
					...
					<div class="form-group <?php if(is_mobile()) echo 'col-xs-6'; else echo 'col-xs-3'; ?>">
						<label>희귀 계정과목 표시 : &nbsp;&nbsp;&nbsp;<input type="checkbox" name="is_sp" value="1" <?php echo set_checkbox('is_sp', '1'); ?> onClick="submit();" <?php if($this->input->post_get('is_sp')!=='') echo 'checked'; ?>></label>
					</div>
				</div>
				<div class="mt10">
					<div class="desc">&nbsp;</div>
...
?>
				...
				<div class="sub_header" onClick="acc_d2_show(2);"><h5>부 채 계 정</h5></div>
				<div class="tb-h5">
					<table id="acc2" class="table table-bordered table-hover table-condensed" style="display:<?if($this->input->post_get('acc_d1')==='2') echo ''; else echo 'none';?>">
<?php
...
?>
				...
				<div class="sub_header" onClick="acc_d2_show(3);"><h5>자 본 계 정</h5></div>
				<div class="tb-h5">
					<table id="acc3" class="table table-bordered table-hover table-condensed" style="display:<?if($this->input->post_get('acc_d1')==='3') echo ''; else echo 'none';?>">
<?php
...
?>
				...
				<div class="sub_header" onClick="acc_d2_show(4);"><h5>수 익 계 정</h5></div>
				<div class="tb-h5">
					<table id="acc4" class="table table-bordered table-hover table-condensed" style="display:<?if($this->input->post_get('acc_d1')==='4') echo ''; else echo 'none';?>">
<?php
...
?>
				...
				<div class="sub_header" onClick="acc_d2_show(5);"><h5>비 용 계 정</h5></div>
				<div class="tb-h5">
					<table id="acc5" class="table table-bordered table-hover table-condensed" style="display:<?if($this->input->post_get('acc_d1')==='5') echo ''; else echo 'none';?>">
<?php
