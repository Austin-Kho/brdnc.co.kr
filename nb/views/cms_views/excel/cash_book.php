<?php
 ...
 switch ($lt->class1) :
 	case '1': $cla1="<span color='#0066ff'>[입금]</span>"; break;
 	case '2': $cla1="<span color='#ff3333'>[출금]</span>"; break;
 	case '3': $cla1="<span color='#669900'>[대체]</span>"; break;
 endswitch;

 switch ($lt->class2) :
 	case '1': $cla2="<span color='#0066ff'>[자산]</span>"; break;
 	case '2': $cla2="<span color='#6600ff'>[부채]</span>"; break;
 	case '3': $cla2="<span color='#0066ff'>[자본]</span>"; break;
 	case '4': $cla2="<span color='#009900'>[수익]</span>"; break;
 	case '5': $cla2="<span color='#ff3333'>[비용]</span>"; break;
 	case '6': $cla2="<span color='#009900'>[본사]</span>"; break;
 	case '7': $cla2="<span color='#669900'>[현장]</span>"; break;
 endswitch;
