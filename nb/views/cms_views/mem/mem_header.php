...
<html lang="ko">
	<head>
		...
		<!-- Bootstrap core CSS -->
    		<link type="text/css" href="<?php echo $this->config->base_url(); ?>static/lib/bootstrap/css/bootstrap.min.css" media="screen" rel="stylesheet">
		<link type="text/css" href="<?php echo $this->config->base_url(); ?>static/css/cms.css" rel="stylesheet">
