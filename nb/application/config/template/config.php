 ...
 */
$config['base_url'] = '';
if (empty($config['base_url'])) exit("/application/config/config.php 파일 안에 있는 &dollar;config&lsqb;&apos;base_url&apos;&rsqb;  변수를 설정하여 주십시요.");  // base_url 의 값을 입력하신 후에는 여기 if 문 자체를 주석처리해도 좋습니다.
