...
alert($where, '');
		...
		// 검색결과 데이터 --------------------------------------------------------//
		$list_num = $this->cms_m1_model->cash_book_list('cb_cms_capital_cash_book, cb_cms_capital_bank_account', $where, '', '', $sh_frm, 'num', '');



		$cb_list = $this->cms_m1_model->cash_book_list('cb_cms_capital_cash_book, cb_cms_capital_bank_account', $where, '', '', $sh_frm, '', 'ex');
		// 검색결과 데이터 --------------------------------------------------------//
    ...
    //
		...
		// 	}
    //
		// 	// $b_acc = $this->cmain_m->sql_result(' SELECT no, name FROM cb_cms_capital_bank_account ORDER BY no ');
    //
    //
    //
