<form class="form-inline">
	<fieldset style="font-size: 12px;">
		<div class="row" style="margin: 0px; <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
			...
			<div class="form-group col-xs-12 col-sm-8 col-md-4" style="padding: 3px 0 3px 10px;">
				...
				<div class="col-xs-2" style="padding: 0;"><input type="text" class="form-control input-sm" id="co_no2" name="co_no2" ime-mode:disabled; style="width:90%; margin: 2px 0;"></div>
				<div class="col-xs-3" style="padding: 0;"><input type="text" class="form-control input-sm" id="co_no3" name="co_no3" ime-mode:disabled; style="width:90%; margin: 2px 0;"></div>
		...
		<div class="row" style="margin: 0px; <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
			...
			<div class="form-group col-xs-12 col-sm-8 col-md-4" style="padding: 3px 0 3px 10px;">
				<input type="text" class="form-control input-sm" id="ceo" name="ceo" placeholder="ID" ime-mode:disabled; style=" margin: 2px 0;">
			</div>
        ...
        <div class="col-xs-4" style="padding: 0;"><input type="text" class="form-control input-sm" id="or_no2" name="or_no2" ime-mode:disabled; style="width:90%; margin: 2px 0;"></div>
    ...
    <div class="row" style="margin: 0px;  <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
      <div class="form-group col-xs-12 col-sm-4 col-md-2" style="padding: 11px 0 3px 15px; background-color: #F8F8F8;">
        <label for="biz_cond" style="width:180px;">
          업태 <span style="color:#cc0000">*</span>
        </label>
      </div>
      <div class="form-group col-xs-12 col-sm-8 col-md-4" style="padding: 3px 0 3px 10px;">
    ...
    <div class="row" style="margin: 0px;  <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
      <div class="form-group col-xs-12 col-sm-4 col-md-2" style="padding: 11px 0 3px 15px; background-color: #F8F8F8;">
        <label for="co_phone1" style="width:180px;">
          대표전화 <span style="color:#cc0000">*</span>
        </label>
      </div>
      <div class="form-group col-xs-12 col-sm-8 col-md-4" style="padding: 3px 0 3px 10px;">
        ...
        <div class="col-xs-3" style="padding: 0;"><input type="text" class="form-control input-sm" id="co_phone2" name="co_phone2" ime-mode:disabled; style="width:90%; margin: 2px 0;"></div>
        <div class="col-xs-3" style="padding: 0;"><input type="text" class="form-control input-sm" id="co_phone3" name="co_phone3" ime-mode:disabled; style="width:90%; margin: 2px 0;"></div>
    ...
    <div class="row" style="margin: 0px;  <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
      <div class="form-group col-xs-12 col-sm-4 col-md-2" style="padding: 11px 0 3px 15px; background-color: #F8F8F8;">
        <label for="user_id" style="width:180px;">FAX</label>
      </div>
      ...
      <div class="form-group col-xs-12 col-sm-4 col-md-2" style="padding: 11px 0 3px 15px;  background-color: #F8F8F8;">
        <label for="user_id" style="width:180px;">기업구분</label>
      </div>
    ...
    <div class="row" style="margin: 0px;  <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
      <div class="form-group col-xs-12 col-sm-4 col-md-2" style="padding: 11px 0 3px 15px;  background-color: #F8F8F8;">
        <label for="user_id" style="width:180px;">
          설립일자 <span style="color:#cc0000">*</span>
        </label>
      </div>
    ...
    <div class="row" style="margin: 0px;  <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
      <div class="form-group col-xs-12 col-sm-4 col-md-2" style="padding: 11px 0 3px 15px; background-color: #F8F8F8;">
        <label for="user_id" style="width:180px;">
          기초잔액 입력월 <span style="color:#cc0000">*</span>
        </label>
      </div>
    ...
    <div class="row" style="margin: 0px;  <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
      <div class="form-group col-xs-12 col-sm-4 col-md-2" style="padding: 11px 0 3px 15px; background-color: #F8F8F8;">
        <label for="user_id" style="width:180px;">
          E-mail(비상) <span style="color:#cc0000">*</span>
        </label>
      </div>
    ...
    <div class="row" style="margin: 0px;  <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
      <div class="form-group col-xs-12 col-sm-4 col-md-2" style="padding: 11px 0 3px 15px; background-color: #F8F8F8;">
        <label for="user_id" style="width:180px;">
          세무서[1] <span style="color:#cc0000">*</span>
        </label>
      </div>
    ...
    <div class="row" style="margin: 0px;  <?php if( !is_mobile()) echo 'border-width:1px 0 0 0; border-style:solid; border-color:#CACAC1;';?>">
      <div class="form-group col-xs-12 col-sm-4 col-md-2" style="padding: 11px 0 3px 15px; background-color: #F8F8F8;">
        <label for="user_id" style="width:180px;">
          회사주소 <span style="color:#cc0000">*</span>
        </label>
      </div>
