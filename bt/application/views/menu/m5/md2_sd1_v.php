		...
		<div class="container" style="text-align: center; padding-top: 50px; <?php if( !is_mobile()) echo 'height: 600px;'?>">
			<div class="page-header">
				<h3>해당 페이지에 대한 조회 권한이 없습니다.<?php echo $_SERVER['HTTP_USER_AGENT']; ?></h3>
			</div>
