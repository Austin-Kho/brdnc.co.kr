...
<html lang="ko">
  ...
  <body role="document">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><strong>[주]바램디앤씨</strong></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#contact">환경설정</a></li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">고창균 님 <span class="caret"></span></a>
    ...
    <div class="container theme-showcase" role="main"  style="background-color: white; padding-bottom: 50px;">