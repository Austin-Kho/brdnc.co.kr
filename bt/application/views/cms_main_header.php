			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li class="<?if( !strpos($this->uri->segment(1), '1')) echo ''; else echo 'active';?>"><a href="<?php echo $this->config->base_url(); ?>m1/">영업관리</a></li>
						<li class="<?if( !strpos($this->uri->segment(1), '2')) echo ''; else echo 'active';?>"><a href="<?php echo $this->config->base_url(); ?>m2/">현장관리</a></li>
						<li class="<?if( !strpos($this->uri->segment(1), '3')) echo ''; else echo 'active';?>"><a href="<?php echo $this->config->base_url(); ?>m3/">자금관리</a></li>
						<li class="<?if( !strpos($this->uri->segment(1), '4')) echo ''; else echo 'active';?>"><a href="<?php echo $this->config->base_url(); ?>m4/">프로젝트</a></li>
						<li class="<?if( !strpos($this->uri->segment(1), '5')) echo ''; else echo 'active';?>"><a href="<?php echo $this->config->base_url(); ?>m5/">환경설정</a></li>
						<li class="dropdown">
