					...
					<!-- =====subject table end===== -->
					<?
						$_m5_1_4_rlt = mysql_query("select _m5_1_4 from cms_mem_auth where user_id='$_SESSION[p_id]' ", $connect);
						$_m5_1_4_row = mysql_fetch_array($_m5_1_4_rlt);

						if(!$_m5_1_4_row[_m5_1_4]||$_m5_1_4_row[_m5_1_4]==0){
					?>
