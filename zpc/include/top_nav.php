	...
	<div style="float:left; width:890px; text-align:right;"><!-- 둘째 줄 -->
		...
		<nav style="text-align:right; height:30px; <?=$padding?>">
			<?
				...
				$url_0 = $cms_url."cms.php";							       /////////////////////////////
				$url_1 = $cms_url."_menu1/work_main.php";			/////////////////////////////
				$url_2 = $cms_url."_menu2/local_main.php";			/////////////////////////////
				// $url_2_2 = $cms_url."_stock/stock_main2.php";		/////////////////////////////
				$url_3 = $cms_url."_menu3/capital_main.php";		/////////////////////////////
				$url_4 = $cms_url."_menu4/project_main.php";		/////////////////////////////
				$url_5 = $cms_url."_menu5/config_main.php";			/////////////////////////////
			...
			?>
			<a href="<?=$cms_url;?>_menu1/work_main.php"><img src="<?=$cms_url;?>images/t_menu_1<?=$a1?>.png" id="tm_img0" onmouseover="img_over(0)" onmouseout="img_out(<?=$b?>)" alt=""></a>
			<a href="<?=$cms_url;?>_menu2/local_main.php"><img src="<?=$cms_url;?>images/t_menu_2<?=$a2?>.png" id="tm_img1" onmouseover="img_over(1)" onmouseout="img_out(<?=$b?>)" alt=""></a>
			<a href="<?=$cms_url?>_menu3/capital_main.php"><img src="<?=$cms_url?>images/t_menu_3<?=$a3?>.png" id="tm_img2" onmouseover="img_over(2)" onmouseout="img_out(<?=$b?>)" alt=""></a>
			<a href="<?=$cms_url?>_menu4/project_main.php"><img src="<?=$cms_url?>images/t_menu_4<?=$a4?>.png" id="tm_img3" onmouseover="img_over(3)" onmouseout="img_out(<?=$b?>)" alt=""></a>
			<a href="<?=$cms_url?>_menu5/config_main.php"><img src="<?=$cms_url?>images/t_menu_5<?=$a5?>.png" id="tm_img4" onmouseover="img_over(4)" onmouseout="img_out(<?=$b?>)" alt=""></a>
		</nav>
	</div>
</div>
